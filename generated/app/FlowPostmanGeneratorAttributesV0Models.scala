 ...
 * Service version: 0.5.78
 * apibuilder 0.14.59 localhost 9000/flow/postman-generator-attributes/0.5.78/play_2_x_json
 */
...
package io.flow.postman.generator.attributes.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsPostmanGeneratorAttributesObjectReference: play.api.libs.json.Reads[ObjectReference] = {
      ...
      } yield ObjectReference(relatedServiceNamespace, resourceType, operationMethod, identifierField)
    }
