 ...
 * Service version: 0.0.5-adam
 * apibuilder 0.14.59 app.apibuilder.io/flow/postman-generator-attributes/0.0.5-adam/play_2_x_json
 */
package io.flow.postman.generator.attributes.v0.models {
   ...
   * @param operationPath This needs to be a full operation path (taken from the service.json)
   *        corresponding with the selected {{operation_method}}.
