 ...
 * Service version: 0.0.4-adam
 * apibuilder 0.14.59 app.apibuilder.io/flow/postman-generator-attributes/0.0.4-adam/play_2_x_json
 */
...
package io.flow.postman.generator.attributes.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsPostmanGeneratorAttributesObjectReference: play.api.libs.json.Reads[ObjectReference] = {
      ...
      } yield ObjectReference(relatedServiceNamespace, resourceType, operationMethod, identifierField, deleteOperationPath)
    }
